...
public final class Query {
    ...
    //TAG
    public final static String CREATE_TAG = "INSERT INTO tags(name) VALUES (?)";
    ...
    public final static String UPDATE_GIFT_CERTIFICATE_BY_ID = "UPDATE gift_certificate SET name=?,description=?,price=?,duration=?,last_update_date = NOW() WHERE id = ?";
    public final static String GET_GIFT_CERTIFICATE_BY_TAG_ID = "SELECT gift_certificate.id,gift_certificate.name,description,price,duration,create_date,last_update_date FROM gift_certificate JOIN gift_certificate_has_tag ON gift_certificate.id = gift_certificate_id JOIN tag ON tag_id = tag.id WHERE tag.id = ?";
